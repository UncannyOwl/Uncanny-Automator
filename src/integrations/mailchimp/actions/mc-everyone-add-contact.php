...
class MC_EVERYONE_ADD_CONTACT {
	...
	public function define_action() {
		...
		$action = array(
			...
			'sentence'              => sprintf( __( 'Add {{a contact:%2$s}} to {{an audience:%1$s}}', 'uncanny-automator' ), $this->action_meta, 'EMAIL' ),
			'select_option_name'    => __( 'Add {{a contact}} to {{an audience}}', 'uncanny-automator' ),
			'priority'              => 10,
			'accepted_args'         => 1,
