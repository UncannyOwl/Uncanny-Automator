...
/**
 * Class FLUENT_BOOKING_GROUP_MEETING_SCHEDULED
 *
 * @pacakge Uncanny_Automator
 */
class FLUENT_BOOKING_GROUP_MEETING_SCHEDULED extends Trigger {
	...
	protected function setup_trigger() {
		...
		$this->set_trigger_code( 'FB_GROUP_MEETING_SCHEDULED' );
		$this->set_trigger_meta( 'FB_MEETING_SCHEDULED' );
		$this->set_trigger_type( 'anonymous' );
		// Trigger sentence - FluentBooking
		$this->set_sentence( esc_attr_x( 'A group meeting is scheduled', 'FluentBooking', 'uncanny-automator' ) );
		$this->set_readable_sentence( esc_attr_x( 'A group meeting is scheduled', 'FluentBooking', 'uncanny-automator' ) );
