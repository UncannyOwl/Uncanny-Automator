 ...
 * Studiocart Trigger
 */
class STUDIOCART_USERCOMPLETESORDER {
	...
	public function __construct() {
		$this->trigger_code = 'USERCOMPLETESORDER';
	...
	public function define_trigger() {
		$trigger = array(
			...
			'sentence'            => sprintf( esc_attr__( 'A user completes an order for {{a product:%1$s}}', 'uncanny-automator' ), $this->trigger_meta ),
			/* translators: Logged-in trigger - Studiocart */
			'select_option_name'  => esc_attr__( 'A user completes an order for {{a product}}', 'uncanny-automator' ),
