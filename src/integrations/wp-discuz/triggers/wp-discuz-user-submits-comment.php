...
/**
 * Class WP_DISCUZ_USER_SUBMITS_COMMENT
 *
 * @package Uncanny_Automator
 */
class WP_DISCUZ_USER_SUBMITS_COMMENT extends \Uncanny_Automator\Recipe\Trigger {
	...
	public function options() {
		return array(
			...
			Automator()->helpers->recipe->field->number_of_times(),
		);
	}
