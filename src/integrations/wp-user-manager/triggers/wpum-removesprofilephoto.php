...
/**
 * Class WPUM_REMOVESPROFILEPHOTO
...
class WPUM_REMOVESPROFILEPHOTO {
	...
	public function __construct() {
		$this->trigger_code = 'WPUMUSERPPHOTOR';
		$this->trigger_meta = 'WPUMPPREMOVED';
		$this->define_trigger();
	}
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => esc_html__( 'A user removes their profile photo', 'uncanny-automator' ),
			/* translators: Logged-in trigger - WP User Manager */
			'select_option_name'  => esc_html__( 'A user removes their profile photo', 'uncanny-automator' ),
