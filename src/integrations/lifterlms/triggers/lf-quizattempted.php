...
class LF_QUIZATTEMPTED {
	...
	public function __construct() {
		$this->trigger_code = 'LFQUIZATTEMPTED';
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( __( 'User attempts {{a/any quiz:%1$s}} {{a number of:%2$s}} times', 'uncanny-automator' ), $this->trigger_meta, 'NUMTIMES' ),
			'select_option_name'  => __( 'User attempts {{a/any quiz}}', 'uncanny-automator' ),
