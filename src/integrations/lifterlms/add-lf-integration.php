...
//		], 30, 2 );
	...
	public function add_integration_func() {
		...
		Automator()->register->integration( self::$integration, array(
			'name'     => 'LifterLMS',
			'icon_svg' => Utilities::automator_get_integration_icon( __DIR__ . '/img/lifterlms-icon.svg' ),
			'logo_svg' => Utilities::automator_get_integration_icon( __DIR__ . '/img/integration-lifterlms.svg' ),
		) );
	}
}
