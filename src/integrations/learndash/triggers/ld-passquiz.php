...
class LD_PASSQUIZ {
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( esc_attr_x( 'A user passes {{a quiz:%1$s}} {{a number of:%2$s}} time(s)', 'Learndash', 'uncanny-automator' ), $this->trigger_meta, 'NUMTIMES' ),
			/* translators: Logged-in trigger - LearnDash */
			'select_option_name'  => esc_attr_x( 'A user passes {{a quiz}}', 'Learndash', 'uncanny-automator' ),
			'action'              => array(
