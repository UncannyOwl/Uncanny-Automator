...
class LD_QUIZPERCENT extends \Uncanny_Automator\Recipe\Trigger {
	...
	protected function setup_trigger() {
		...
		$this->set_sentence(
			sprintf(
				// translators: %1$s: Condition. %2$s: Percentage. %3$s: Quiz. %4$s: Number of times.
				esc_html_x( 'A user achieves a percentage {{greater than, less than or equal to:%1$s}} {{a value:%2$s}} on {{a quiz:%3$s}} {{a number of:%4$s}} time(s)', 'LearnDash', 'uncanny-automator' ),
