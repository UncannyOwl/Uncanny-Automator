...
class LD_QUIZPERCENT {
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( __( 'User achieves {{<, >, =:%1$s}} {{a percentage X:%2$s}}%% on {{a quiz:%3$s}} {{a number of:%4$s}} times', 'uncanny-automator' ), 'NUMBERCOND', 'QUIZPERCENT', $this->trigger_meta, 'NUMTIMES' ),
			'select_option_name'  => __( 'User achieves {{<, >, =}} {{a percentage X}}% on {{a quiz}} ', 'uncanny-automator' ),
			...
			'options'             => [
				...
				$uncanny_automator->helpers->recipe->field->integer_field( 'QUIZPERCENT', __( 'Enter Percentage', 'uncanny-automator' ), '', __( 'Enter Percentage', 'uncanny-automator' ) ),
