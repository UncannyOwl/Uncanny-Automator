	...
	public function setup_action() {
		...
		$this->set_sentence(
			sprintf(
				...
				esc_html__( 'Create a task in {{a specific list:%1$s}} in {{a specific folder:%2$s}} in {{a specific space:%3$s}} in {{a specific team:%4$s}}', 'uncanny-automator' ),
		...
		$this->set_readable_sentence( esc_html__( 'Create a task in {{a specific list}} in {{a specific folder}} in {{a specific space}} in {{a specific team}}', 'uncanny-automator' ) );
