...
class AMELIA_REGISTER_EVENT {
	...
	public function setup_trigger() {
		...
		$this->set_sentence( sprintf( esc_html_x( 'A guest registers for {{an event:%1$s}}', 'Amelia Booking', 'uncanny-automator' ), $this->get_trigger_meta() ) );

		/* Translators: Trigger sentence */
		$this->set_readable_sentence( esc_html_x( 'A guest registers for {{an event}}', 'Amelia Booking', 'uncanny-automator' ) ); // Non-active state sentence to show
