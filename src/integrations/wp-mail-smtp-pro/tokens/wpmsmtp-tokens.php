		...
		if ( in_array( $trigger_code, $trigger_meta_validations, true ) ) {
			...
			$fields = array(
				array(
					...
					'tokenName'       => esc_html__( 'Email log ID', 'uncanny-automator' ),
					'tokenType'       => 'int',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'TO_EMAIL',
					'tokenName'       => esc_html__( 'To email', 'uncanny-automator' ),
					'tokenType'       => 'email',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'FROM_EMAIL',
					'tokenName'       => esc_html__( 'From email', 'uncanny-automator' ),
					'tokenType'       => 'email',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'EMAIL_SOURCE',
					'tokenName'       => esc_html__( 'Email source', 'uncanny-automator' ),
					'tokenType'       => 'text',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'EMAIL_SUBJECT',
					'tokenName'       => esc_html__( 'Email subject', 'uncanny-automator' ),
					'tokenType'       => 'text',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'EMAIL_BODY',
					'tokenName'       => esc_html__( 'Email body', 'uncanny-automator' ),
					'tokenType'       => 'text',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'EMAIL_STATUS',
					'tokenName'       => esc_html__( 'Email status', 'uncanny-automator' ),
					'tokenType'       => 'text',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'EMAIL_TECH_DETAILS',
					'tokenName'       => esc_html__( 'Technical details', 'uncanny-automator' ),
					'tokenType'       => 'text',
					'tokenIdentifier' => $trigger_code,
				),
				array(
					'tokenId'         => 'EMAIL_SENT_DATE',
					'tokenName'       => esc_html__( 'Date sent', 'uncanny-automator' ),
					'tokenType'       => 'text',
					'tokenIdentifier' => $trigger_code,
				),
			);
