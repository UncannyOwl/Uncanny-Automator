...
class Add_Upsell_Plugin_Integration {
	...
	public function add_integration_func() {
		...
		$uncanny_automator->register->integration( self::$integration, array(
			'name'     => 'Upsell Plugin',
			// 'icon_svg' => Utilities::get_integration_icon( 'integration-upsell-icon.png' ),
			'icon_16'     => Utilities::get_integration_icon( 'integration-upsells-plugin-icon-16.png' ),
			'icon_32'     => Utilities::get_integration_icon( 'integration-upsells-plugin-icon-32.png' ),
			'icon_64'     => Utilities::get_integration_icon( 'integration-upsells-plugin-icon-64.png' ),
		) );
	}
}