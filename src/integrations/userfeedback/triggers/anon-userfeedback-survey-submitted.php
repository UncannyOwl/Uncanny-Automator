...
class ANON_USERFEEDBACK_SURVEY_SUBMITTED {
	...
	protected function setup_trigger() {
		...
		$this->set_sentence( sprintf( esc_attr_x( 'A visitor submits {{a survey:%1$s}}', 'Userfeedback', 'uncanny-automator' ), $this->trigger_meta ) );
		$this->set_readable_sentence( esc_attr_x( 'A visitor submits {{a survey}}', 'Userfeedback', 'uncanny-automator' ) );
	...
	public function load_options() {
		...
		$options = array( '-1' => esc_html_x( 'Any survey', 'UserFeedback', 'uncanny-automator' ) );
