...
class Add_Gf_Integration {
	...
	public function add_integration_func() {
		...
		$uncanny_automator->register->integration( self::$integration, array(
			'name'        => 'Gravity Forms',
			'icon_16'     => Utilities::get_integration_icon( 'integration-gravityforms-icon-16.png' ),
			'icon_32'     => Utilities::get_integration_icon( 'integration-gravityforms-icon-32.png' ),
			'icon_64'     => Utilities::get_integration_icon( 'integration-gravityforms-icon-64.png' ),
			'logo'        => Utilities::get_integration_icon( 'integration-gravityforms.png' ),
			'logo_retina' => Utilities::get_integration_icon( 'integration-gravityforms@2x.png' ),
		) );
	}
}