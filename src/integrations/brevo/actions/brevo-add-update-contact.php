...
class BREVO_ADD_UPDATE_CONTACT extends \Uncanny_Automator\Recipe\Action {
	...
	protected function process_action( $user_id, $action_data, $recipe_id, $args, $parsed ) {
		...
		$double_optin    = filter_var( $this->get_parsed_meta_value( 'DOUBLE_OPT_IN', false ), FILTER_VALIDATE_BOOL );
		$update_existing = filter_var( $this->get_parsed_meta_value( 'UPDATE_EXISTING_CONTACT', false ), FILTER_VALIDATE_BOOL );
