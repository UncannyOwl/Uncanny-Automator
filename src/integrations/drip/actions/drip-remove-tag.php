...
class DRIP_REMOVE_TAG {
	...
	public function setup_action() {
		...
		$this->set_sentence( sprintf( esc_attr__( 'Remove {{a tag:%1$s}} from {{a subscriber:%2$s}}', 'uncanny-automator' ), $this->get_action_meta(), 'EMAIL:' . $this->get_action_meta() ) );
	...
	protected function process_action( $user_id, $action_data, $recipe_id, $args, $parsed ) {
		...
		try {
			...
			$response = $this->functions->remove_tag( $email, $tag );
