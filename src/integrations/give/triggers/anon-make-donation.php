...
class ANON_MAKE_DONATION {
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( esc_html__( 'A donation is made via {{a form:%1$s}}', 'uncanny-automator' ), $this->trigger_meta ),
			/* translators: Logged-in trigger - GiveWP */
			'select_option_name'  => esc_html__( 'A donation is made via {{a form}}', 'uncanny-automator' ),
