...
class BDB_USERSENTINVITE {
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => esc_html__( 'A user sends an email invitation', 'uncanny-automator' ),
			'select_option_name'  => esc_html__( 'A user sends an email invitation', 'uncanny-automator' ),
