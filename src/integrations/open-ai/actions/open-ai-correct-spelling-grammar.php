 ...
 * @since 4.11
 */
class OPEN_AI_CORRECT_SPELLING_GRAMMAR {
	...
	protected function setup_action() {
		...
		$this->set_sentence(
			sprintf(
				...
				esc_attr__( 'Correct {{spelling and grammar:%1$s}} with GPT-4', 'uncanny-automator' ),
				'FILLER:' . $this->get_action_meta()
			)
		);

		/* translators: Action sentence */
		$this->set_readable_sentence( esc_attr__( 'Correct {{spelling and grammar}} with GPT-4', 'uncanny-automator' ) );
