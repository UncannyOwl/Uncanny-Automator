...
/**
 * Class THRIVE_APPRENTICE_USER_SUBMITS_ASSESSMENT_IN_COURSE
 *
 * @package Uncanny_Automator
 */
class THRIVE_APPRENTICE_USER_SUBMITS_ASSESSMENT_IN_COURSE extends Trigger {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'THRIVE_APPRENTICE_USER_SUBMITS_ASSESSMENT_IN_COURSE';
	 ...
	 * @var string
	 */
	const TRIGGER_META = 'THRIVE_APPRENTICE_USER_SUBMITS_ASSESSMENT_IN_COURSE_META';
	...
	protected function setup_trigger() {
		...
		// Hook into assessment submission event
		$this->add_action( 'tva_assessment_submitted' );
		...
		$this->set_sentence(
			sprintf(
				...
				esc_html_x( 'A user submits {{an assessment:%2$s}} in {{a course:%1$s}}', 'Thrive Apprentice', 'uncanny-automator' ),
		...
		$this->set_readable_sentence(
			esc_html_x( 'A user submits {{an assessment}} in {{a course}}', 'Thrive Apprentice', 'uncanny-automator' )
		);
	}
