...
class MAKE_SENDWEBHOOK {
	...
	protected function setup_action() {
		...
		$this->set_action_code( 'MAKESENDWEBHOOK' );

		$this->set_action_meta( 'MAKEWEBHOOK' );
		...
		$this->set_sentence(
			...
			/* translators: Trigger sentence */
				esc_attr_x( 'Send data to Make {{webhook:%1$s}}', 'Make', 'uncanny-automator' ),
		...
		$this->set_readable_sentence(
			esc_attr_x( 'Send data to Make {{webhook}}', 'Make', 'uncanny-automator' )
		);
