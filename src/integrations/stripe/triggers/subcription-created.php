...
/**
 * Class Subcription_Created
 *
 * @package Uncanny_Automator
 */
class Subcription_Created extends \Uncanny_Automator\Recipe\Trigger {
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Product name */
				esc_attr__( '{{A subscription:%1$s}} is created', 'uncanny-automator' ),
		...
		$this->set_readable_sentence( esc_attr__( '{{A subscription}} is created', 'uncanny-automator' ) );
