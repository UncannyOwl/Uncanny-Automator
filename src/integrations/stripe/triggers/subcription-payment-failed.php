...
/**
 * Class Subcription_Payment_Failed
 *
 * @package Uncanny_Automator
 */
class Subcription_Payment_Failed extends \Uncanny_Automator\Recipe\Trigger {
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Product name */
				esc_attr__( '{{A subscription:%1$s}} payment fails', 'uncanny-automator' ),
		...
		$this->set_readable_sentence( esc_attr__( '{{A subscription}} payment fails', 'uncanny-automator' ) );

		// Which do_action() fires this trigger.
		$this->add_action( Stripe_Webhook::INVOICE_ITEM_PAYMENT_FAILED_ACTION );
