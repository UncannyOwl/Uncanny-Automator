...
/**
 * Class AUTONAMI_CONTACT_ADDED_TO_LIST
 *
...
class AUTONAMI_CONTACT_ADDED_TO_LIST {
	...
	public function setup_trigger() {
		...
		$this->set_trigger_code( 'CONTACT_ADDED_TO_LIST' );
		...
		$this->set_sentence( sprintf( 'A contact is added to {{a list:%1$s}}', $this->get_trigger_meta() ) );

		$this->set_readable_sentence( 'A contact is added to {{a list}}' );
