...
/**
 * Class AUTONAMI_CONTACT_TAG_ADDED
 *
...
class AUTONAMI_CONTACT_TAG_ADDED {
	...
	public function setup_trigger() {
		...
		$this->set_sentence( sprintf( '{{A tag:%1$s}} is added to a contact', $this->get_trigger_meta() ) );

		$this->set_readable_sentence( '{{A tag}} is added to a contact' );
