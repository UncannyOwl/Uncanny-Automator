		...
		$action = array(
			...
			'options_group'      => array(
				$this->action_meta => array(
					$uncanny_automator->helpers->recipe->slack->options->get_slack_users( null, 'SLACKUSER' ),
					$uncanny_automator->helpers->recipe->slack->textarea_field( 'SLACKMESSAGE', esc_attr__( 'Message', 'uncanny-automator' ), true, 'textarea', '', true, __( '* Markdown is supported', 'uncanny-automator' ), __( 'Enter the message', 'uncanny-automator' ) ),
				),
			),
		);
