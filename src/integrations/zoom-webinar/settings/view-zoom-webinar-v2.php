...
<form method="POST" action="options.php" warn-unsaved>
			...
			<div class="uap-settings-panel-content">
				...
				if ( $this->is_connected ) {
					...
					echo sprintf(
						...
						esc_html__( 'JWT apps for Zoom Webinars will be deprecated in June 2023. To keep your recipes running without interruption, please disconnect and then reconnect your account using the new Zoom app. %1$s.', 'uncanny-automator' ),
	...
	<input type="hidden" name="uap_automator_zoom_webinar_api_settings_timestamp" value="<?php esc_attr( time() ); ?>" >
</form>
