...
<div id="uap-review-banner" class="uap notice">
	...
	>
		...
		<img 
			slot="icon"
			src="<?php echo esc_url( Utilities::automator_get_asset( 'build/img/credits-left-zero.svg' ) ); ?>"
			width="90px"
		>
		...
		<div class="uap-spacing-top">
			<uo-button
				...
				href="https://automatorplugin.com/pricing/?utm_source=uncanny-automator&utm_medium=in-plugin&utm_content=credit-notification-0-credits-left&utm_campaign=get-unlimited-credits"
