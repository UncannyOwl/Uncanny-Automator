...
class Recipe_Post_Type {
	...
	public function automator_post_type() {
		...
		if ( ! post_type_exists( AUTOMATOR_POST_TYPE_RECIPE ) ) {
			...
			register_post_type( AUTOMATOR_POST_TYPE_RECIPE, apply_filters( 'automator_post_type_recipe_args', $args ) );
		}
	}
	...
	public function all_recipes_css() {
		...
		if ( AUTOMATOR_POST_TYPE_RECIPE !== $current_screen->post_type || 'edit-uo-recipe' !== $current_screen->id ) {
			return;
		}
		?>
