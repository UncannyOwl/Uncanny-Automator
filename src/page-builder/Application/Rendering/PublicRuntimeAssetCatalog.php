...
final class PublicRuntimeAssetCatalog
{
    ...
    private const ASSETS = [
        ...
        // Existing publications can still name these frozen generic artifacts.
        'anime' => [
            'kind' => 'script',
        ...
        'anime_page_builder' => [
            'kind' => 'script',
            'plugin_path' => 'assets/js/anime-page-builder.min.js',
            'export_source_path' => 'assets/js/anime-page-builder.min.js',
            'reference' => 'assets/anime-page-builder.min.js',
            'mime_type' => 'application/javascript',
            'required' => false,
            'library_slug' => 'anime',
        ],
        ...
        'swiper_page_builder' => [
            'kind' => 'script',
            'plugin_path' => 'assets/js/swiper-page-builder.min.js',
            'export_source_path' => 'assets/js/swiper-page-builder.min.js',
            'reference' => 'assets/swiper-page-builder.min.js',
            'mime_type' => 'application/javascript',
            'required' => false,
            'library_slug' => 'swiper',
        ],
        ...
        'swiper_styles_page_builder' => [
            'kind' => 'style',
            'plugin_path' => 'assets/css/swiper-page-builder.min.css',
            'export_source_path' => 'assets/css/swiper-page-builder.min.css',
            'reference' => 'assets/swiper-page-builder.min.css',
            'mime_type' => 'text/css; charset=utf-8',
            'required' => false,
            'library_slug' => 'swiper',
        ],
