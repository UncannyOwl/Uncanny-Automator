 ...
 *
 * @return \Uncanny_Automator\App\Plan\Domain\Plan Current plan instance.
 */
 ...
 * @return \Uncanny_Automator\App\Plan\Domain\Plan|WP_Error Plan instance or error.
 */
...
function automator_is_valid_plan_id( string $plan_id ) {
	...
	return Plan_Implementation::is_valid( $plan_id );
}
...
function automator_get_available_plan_ids() {
	return array_keys( Plan_Implementation::HIERARCHY );
}
