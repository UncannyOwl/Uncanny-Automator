...
namespace Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools;

// Recipe tools.
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Recipes\Get_Recipe_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Recipes\List_Recipes_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Recipes\Save_Recipe_Tool;

// Discovery tools.
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Search_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Get_Component_Schema_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Get_Posts_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Get_Terms_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\List_Plugins_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\List_Users_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\List_Roles_Tool;

// MySQL tools.
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Mysql_Get_Tables_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Mysql_Get_Table_Columns_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Mysql_Select_From_Table_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Mysql_Get_Cell_Chunk_Tool;

// Consolidated CRUD tools.
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Triggers\Save_Trigger_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Actions\Save_Action_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Conditions\Save_Condition_Group_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Conditions\Save_Condition_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Loops\Save_Loop_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Loops\Save_Loop_Filter_Tool;

// Consolidated utility tools.
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Execute_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Get_Tokens_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Get_Logs_Tool;
use Uncanny_Automator\App\Transports\Model_Context_Protocol\Tools\Catalog\Delete_Tool;
...
use Uncanny_Automator\App\Recipe_Builder\Shared\Security\Security;
...
class Tool_Registry {
	...
	public function auto_register_tools() {
		...
		Dispatcher::action( 'uncanny_automator_mcp_tool_registry_register', $this );
	}
}
