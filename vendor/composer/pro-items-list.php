	...
	return array(
		...
		'AFFWP' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( 'An affiliate refers a sale of {{a MemberPress product}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( "Set an affiliate's commission rate", 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
			),
		...
		'AMELIABOOKING' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( 'An appointment is booked for {{a specific service}} in {{a specific category}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'BDB' => array(
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( "Set the user's profile type to {{a specific type}}", 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
		...
		'DIVI' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( 'A user submits {{a form}} with {{a value}} in {{a field}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'EDD_RECURRING' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( "A user's subscription to {{a download}} is renewed", 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'ELEM' => array(
			...
			'actions'    => array(
				array(
					'name'     => esc_html_x( 'Show {{a popup}}', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
			),
		...
		'FLUENT_COMMUNITY' => array(
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( 'Mark {{a course}} as complete for a user', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
					'name'     => esc_html_x( 'Mark {{a lesson}} as complete for a user', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
		...
		'GIVEWP' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( 'A user makes a donation via {{a form}} for an amount {{greater than, less than, or equal to}} {{an amount}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'GP' => array(
			...
			'triggers'   => array(
				array(
					'name'     => esc_html_x( '{{An achievement}} is revoked from a user', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'MEC' => array(
			...
			'actions'    => array(
				array(
					'name'     => esc_html_x( 'Register the user for {{an event}}', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
			),
		...
		'SURECART' => array(
			...
			'triggers'   => array(
				array(
					'name'     => esc_html_x( "A guest's order status is changed to confirmed", 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'UARESTRICTCONTENT' => array(
			'name'       => 'Restrict Content',
			'pro_only'   => 'no',
			'elite_only' => 'no',
			'triggers'   => array(
				array(
					'name'     => esc_html_x( 'A user is added to {{an access level}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => false,
					'is_elite' => false,
				),
				array(
					'name'     => esc_html_x( 'A user is removed from {{an access level}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => false,
					'is_elite' => false,
				),
			...
			'actions'    => array(
				array(
					'name'     => esc_html_x( 'Add the user to {{an access level}}', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => false,
					'is_elite' => false,
				),
				array(
					'name'     => esc_html_x( 'Remove the user from {{an access level}}', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => false,
					'is_elite' => false,
				),
			),
		...
		'UOA' => array(
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( '{{Deactivate or activate}} {{a recipe}}', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
			),
		...
		'WC' => array(
			...
			'triggers'   => array(
				array(
					'name'     => esc_html_x( 'An order is created', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
					'name'     => esc_html_x( '{{A product}} has its associated order {{completed, paid for, thank you page visited}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
				...
				array(
					'name'     => esc_html_x( 'A guest makes {{a purchase}} with {{a specific coupon}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
					'name'     => esc_html_x( '{{A product}} is out of stock', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
				...
				array(
					'name'     => esc_html_x( 'A guest {{purchases}} a product in {{a category}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
				...
				array(
					'name'     => esc_html_x( 'A guest {{purchases}} {{a product variation}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
				...
				array(
					'name'     => esc_html_x( 'A user {{completes}} an order with {{a specific payment method}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
				...
				array(
					'name'     => esc_html_x( 'A {{type of}} coupon is created', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( 'Add {{a product}} to the cart', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
		...
		'WCMEMBERSHIPS' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( "A user's access to {{a membership plan}} cancelled", 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
		...
		'WOOCOMMERCE_SUBSCRIPTION' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( 'A user renews a subscription to {{a product variation}} of {{a variable subscription}}', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'logged-in',
					'is_pro'   => true,
					'is_elite' => false,
				),
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( "Extend a user's subscription to {{a specific product}} by {{a number of}} {{duration type}}", 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
		...
		'WP' => array(
			...
			'actions'    => array(
				...
				array(
					'name'     => esc_html_x( 'Remove {{a role}} from the user', 'Automator Pro item', 'uncanny-automator' ),
					'is_pro'   => true,
					'is_elite' => false,
				),
				array(
		...
		'WPCODE_IHAF' => array(
			...
			'triggers'   => array(
				...
				array(
					'name'     => esc_html_x( '{{A snippet}} throws an error', 'Automator Pro item', 'uncanny-automator' ),
					'type'     => 'anonymous',
					'is_pro'   => true,
					'is_elite' => false,
				),
