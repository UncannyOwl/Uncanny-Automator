...
const URL = '/edit.php?post_type=uo-recipe&page=uncanny-automator-config';

exports.PlaywrightAutomatorSettings = class PlaywrightAutomatorSettings {
  ...
  async openTab(tabName) {
    await this.page.locator('uo-tab').filter({ hasText: tabName }).locator('a').click();
  }
